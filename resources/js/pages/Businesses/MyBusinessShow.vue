        ...
        <div class="bg-gradient-to-br from-slate-50 to-gray-100 w-full min-h-screen">
                    ...
                    <div class="w-full max-w-7xl mx-auto">
                        <div class="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-8">
                            ...
                            <div class="relative flex-shrink-0">
                                <div class="w-24 h-24 sm:w-32 sm:h-32 rounded-2xl bg-white shadow-2xl flex items-center justify-center border-4 border-white/50 backdrop-blur-sm">
                                    <Briefcase class="w-12 h-12 sm:w-16 sm:h-16 text-primary" />
                                </div>
                                <div class="absolute -top-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 bg-green-500 rounded-full border-4 border-white flex items-center justify-center">
                            ...
                            <div class="text-white text-center sm:text-left pb-0 sm:pb-4 flex-1 min-w-0">
                                <div class="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-3 mb-2">
                                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold truncate max-w-full">{{ business.name }}</h1>
                                    <!-- <VerifiedBadge :size="32" color="#3B82F6" /> -->
                                </div>
                                <p class="text-indigo-200 text-base sm:text-lg font-medium break-words">{{ business.email }}</p>
            ...
            <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 -mt-4 sm:-mt-8 relative z-20">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-200/50">
                        <div class="flex items-center justify-between">
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-gray-900 truncate">{{ new Date(business.created_at).toDateString() }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-200/50">
                        <div class="flex items-center justify-between">
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-lg sm:text-2xl font-bold text-gray-900">{{business.signboards.length}}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 border border-gray-200/50 sm:col-span-2 lg:col-span-1">
                        <div class="flex items-center justify-between">
                            <div class="min-w-0 flex-1">
                            ...
                            <div class="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-lg flex items-center justify-center flex-shrink-0 ml-3">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 border border-gray-200/50">
                    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full lg:w-auto">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900 flex-shrink-0">Connect with us:</h3>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                            <MyBusinessUpdate :business="business" @updated="$inertia.reload()">
                                <Button class="bg-primary hover:bg-primary/90 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all text-sm sm:text-base">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 border border-gray-200/50">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                        <div v-if="business.signboards.length"
                            ...
                            <div class="aspect-video bg-gradient-to-br from-indigo-50 to-purple-50 p-4 sm:p-6 flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs sm:text-sm font-medium text-gray-600"> {{ signboard.region.name }}</p>
                                </div>
                            </div>
                            <div class="p-3 sm:p-4">
                                <h3 class="font-semibold text-gray-900 mb-1 text-sm sm:text-base truncate">Location {{ signboard.town }}</h3>
                                <p class="text-xs sm:text-sm text-gray-500 mb-3">Active since {{new Date(signboard.created_at).toDateString() }}</p>
                                <div class="flex justify-between items-center"><span class="inline-flex items-center
                                 px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800"><div class="w-1.5 h-1.5 bg-green-500 rounded-full mr-1.5"></div>Active</span>
                                    <div class="flex gap-1 sm:gap-2">
                                        ...
                                        <Link  :href="route('my-signboards.show', signboard.slug)"
                                               variant="ghost" size="sm" class="text-gray-500 hover:text-primary p-1 sm:p-2">
                        ...
                        <div v-else class="col-span-full flex flex-col items-center justify-center text-center text-gray-600 px-4 py-8">
