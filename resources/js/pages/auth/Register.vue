    ...
    >
        ...
        <Card class="w-120 mx-auto mt-0">
            <CardHeader class="text-center">
                ...
                <CardDescription>
                    Register a free account with Signboard GH
                </CardDescription>
            </CardHeader>

            <CardContent>
                <form @submit.prevent="submit" class="flex flex-col gap-6 w-full md:w-full justify-center">
                    ...
                    <div class="text-center text-sm text-muted-foreground">
                        ...
                        <TextLink :href="route('login')" :tabindex="5">Sign In</TextLink>
                    </div>
                </form>
            </CardContent>
