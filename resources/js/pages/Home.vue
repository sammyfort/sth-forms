        ...
        <div class="w-full">
            ...
            <div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
                <div class="max-w-4xl mx-auto">
                    <h1 class="text-center mb-3 text-gray-400 font-medium">Trusted by 5,000+ Businesses Across Ghana</h1>
                    <div class="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
                        <img src="/images/tmp/company/google.svg" class="h-7">
                        <img src="/images/tmp/company/netflix.svg" class="h-7">
                        <img src="/images/tmp/company/airbnb.svg" class="h-7">
                        <img src="/images/tmp/company/amazon.svg" class="h-7 transform translate-y-2">
                        <img src="/images/tmp/company/facebook.svg" class="h-7">
                        <img src="/images/tmp/company/grab.svg" class="h-7">
                    </div>
                </div>

                <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24 aos-init aos-animate">
                    <h1 class="font-bold text-secondary my-3 text-2xl">All-In-One <span class="text-primary">Signboard Platform.</span></h1>
                    <p class="leading-relaxed text-gray-500">Signboard Ghana offers everything you need to showcase your business location and signage to online visitors.</p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
                    ...
                    <div data-aos="fade-up" class="bg-white shadow-xl p-6 text-center rounded-xl aos-init aos-animate">
                        <div class="rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12"
                             style="background: rgb(91, 114, 238);">
                            <svg>...</svg>
                        </div>
                        <h1 class="font-medium text-xl mb-3 lg:px-14 text-secondary">Manage Your Listings</h1>
                        <p class="px-4 text-gray-500">Easily add, edit, or remove your signboard listings to keep your business info up to date and relevant.</p>
                    </div>
                    <!-- Feature 2 -->
                    <div data-aos="fade-up" data-aos-delay="150"
                        ...
                        <h1 class="font-medium text-xl mb-3 lg:px-14 text-secondary">Map-Based Discovery</h1>
                        <p class="px-4 text-gray-500">
                            Help users explore businesses nearby by viewing signboards on an interactive map with filters for category and location.
                        </p>
                    </div>
                    <!-- Feature 3 -->
                    <div data-aos="fade-up" data-aos-delay="300"
                        ...
                        <h1 class="font-medium text-xl mb-3 lg:px-14 text-secondary lg:h-14">Track Customer Interactions</h1>
                        <p class="px-4 text-gray-500">Gain insights on how many people viewed your signboard and follow up with interested clients in real-time.</p>
                    </div>
                </div>

                <div class="mt-28">
                    <div data-aos="flip-down" class="text-center max-w-screen-md mx-auto aos-init aos-animate">
                        <h1 class="text-3xl font-bold mb-4">What is <span class="text-primary">Signboard?</span></h1>
                        <p class="text-gray-500">
                            Signboard is a web platform that lets businesses showcase their physical signboards online, making them discoverable by customers based on location, category, and reviews.
                        </p>
                    </div>
                    <div data-aos="fade-up"
                         class="flex flex-col md:flex-row justify-center gap-y-5 md:gap-y-0 md:gap-x-6 lg:gap-x-10 mt-7 aos-init aos-animate">
                ...
                <div class="sm:flex items-center sm:gap-x-8 mt-36">
                    <div data-aos="fade-right" class="sm:w-1/2 relative aos-init aos-animate">
                        ...
                        <h1 class="font-semibold text-2xl relative z-50 text-secondary lg:pr-10">
                            Everything you need to showcase your business, <span class="text-primary">right from your signboard</span>
                        </h1>
                    ...
                    <div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0 aos-init aos-animate">
                        ...
                        <button
                            ...
                            <svg viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-1">
                                <path
                                    d="M22.5751 12.8097C23.2212 13.1983 23.2212 14.135 22.5751 14.5236L1.51538 27.1891C0.848878 27.5899 5.91205e-07 27.1099 6.25202e-07 26.3321L1.73245e-06 1.00123C1.76645e-06 0.223477 0.848877 -0.256572 1.51538 0.14427L22.5751 12.8097Z"
                                    fill="#23BDEE"></path>
                            </svg>
                        ...
                        <!-- Floating Square -->
                        <div class="bg-primary w-40 h-40 floating absolute rounded-lg z-10 -bottom-3 -right-3"></div>
                    </div>
                </div>

                <div class="mt-24 flex flex-col md:flex-row items-center md:gap-x-10 justify-center">
                    <div data-aos="fade-right" class="md:w-5/12 aos-init aos-animate">
                        <h1 class="text-secondary font-semibold text-3xl lg:pr-20">
                            <span class="text-primary">Boost Your Business</span> Visibility
                        </h1>
                        <p class="text-gray-500 my-5 lg:pr-10">
                            Promote your company or services directly on the Signboard platform. Run targeted ads, highlight your listings, and attract more customers based on location, category, or interests.
                        </p>
                        <p class="text-gray-500 my-5 lg:pr-10">
                ...
                <div class="md:flex mt-40 md:gap-x-10 items-start">
                    ...
                    <div data-aos="fade-down" class="md:w-7/12 relative aos-init aos-animate">
                        ...
                        <img src="/images/tmp/vcall.png" alt="Signboard UI" class="relative z-50 floating">
                    ...
                    <div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500 aos-init aos-animate">
                        <h1 class="text-2xl font-semibold text-secondary lg:pr-40">
                            A <span class="text-primary">user interface</span> built for businesses
                        </h1>
                        ...
                        <div class="flex items-center gap-x-5 my-5">
                            <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                                <svg viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
                            ...
                            <p>Business owners can easily upload and manage signboard listings with images, categories, and locations.</p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-5 my-5">
                            ...
                            <p>Visitors can search signboards by business name, category, or location — with map-based navigation.</p>
                        </div>
                ...
                <div class="flex flex-col md:flex-row items-center md:gap-x-10 mt-16">
                    <div data-aos="fade-right" class="md:w-1/2 lg:pl-14 aos-init aos-animate">
                        <h1 class="text-secondary font-semibold text-3xl lg:pr-56">
                            <span class="text-primary">Tools</span> for Businesses and Users
                        </h1>
                ...
                <div class="mt-20 flex flex-col-reverse md:flex-row items-center md:gap-x-10">
                    <div data-aos="fade-right" class="md:w-6/12 aos-init aos-animate">
                        <img src="/images/tmp/true-false.png" class="md:w-11/12" alt="Ratings and feedback">
                    </div>
                    <div data-aos="fade-left" class="md:w-6/12 md:transform md:-translate-y-20 aos-init aos-animate">
                        <h1 class="font-semibold text-secondary text-3xl lg:pr-64">Ratings, <span class="text-primary">Reviews</span>, Feedback</h1>
                        <p class="text-gray-500 my-5 lg:pr-52">
                            Users can rate and review signboards based on visibility, design, or effectiveness. Business owners can monitor their average rating and see real-time feedback to improve engagement.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center mt-12">
                    <div data-aos="fade-right" class="md:w-5/12 aos-init aos-animate">
                        <h1 class="text-secondary font-semibold text-3xl leading-tight lg:pr-32">
                            <span class="text-primary">Management</span> Tools for Business Owners
                        </h1>
                        <p class="my-5 lg:pr-14">
                            Business owners can upload, edit, or remove their signboard listings. They can view real-time statistics such as profile views, manage customer reviews, and update their location and category anytime.
                        </p>
                    </div>
                    <img data-aos="fade-left" src="/images/tmp/gradebook.png" class="md:w-7/12 aos-init aos-animate" alt="Management dashboard">
                </div>

                <div class="mt-24 flex flex-col-reverse md:flex-row items-center md:gap-x-10">
                    <div data-aos="fade-right" class="md:w-7/12 aos-init aos-animate">
                        <img src="/images/tmp/discussion.png" class="md:w-11/12" alt="Customer feedback">
                    </div>
                    <div data-aos="fade-left" class="md:w-5/12 md:transform md:-translate-y-6 aos-init aos-animate">
                        <h1 class="font-semibold text-secondary text-3xl lg:pr-64">
                            Customer <span class="text-primary">Engagement</span>
                        </h1>
                        <p class="text-gray-500 my-5 lg:pr-24">
                            Business owners can receive and respond to reviews, track user interest through view counts, and stay notified of new interactions to keep customers engaged.
                        </p>
                    </div>
                </div>

                <button data-aos="flip-up"
                        class="px-5 py-3 border border-primary text-primary font-medium my-14 btn-zoom rounded-full mx-auto block aos-init aos-animate">
                ...
                <div class="mt-24 flex flex-col-reverse md:flex-row items-start md:gap-x-10">
                    <div data-aos="zoom-in-right" class="md:w-5/12 aos-init aos-animate">
                        <div class="flex items-center gap-x-20 mb-5">
                            <span class="border border-gray-300 w-14 absolute"></span>
                            <h1 class="text-gray-400 tracking-widest text-sm">TESTIMONIAL</h1>
                        </div>
                        <h1 class="font-semibold text-secondary text-2xl lg:pr-40">What Businesses Are Saying</h1>
                        <p class="text-gray-500 my-5 lg:pr-36">The Signboard App has received glowing feedback from business owners and customers across the country.</p>
                        <p class="text-gray-500 my-5 lg:pr-36">Many businesses have seen increased visibility and customer engagement since joining the platform.</p>
                        <p class="text-gray-500 my-5 lg:pr-36">Have a great experience? Share your feedback with us.</p>
                        <button
                            class="flex items-center gap-x-3 pl-3 border-b border-l border-t border-primary text-primary font-medium my-4 btn-zoom rounded-full">
                    ...
                    <div data-aos="zoom-in-left" class="md:w-7/12 aos-init aos-animate">
                        <img src="/images/tmp/testimonials.png" class="md:w-10/12 mx-auto">
                    </div>
                </div>
