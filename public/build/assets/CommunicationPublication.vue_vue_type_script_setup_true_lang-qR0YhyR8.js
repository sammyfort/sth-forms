import{_ as o}from"./InputSelect.vue_vue_type_script_setup_true_lang-Cc8Eqy3o.js";import{d as a,c as m,o as d,b as r,a as t}from"./app-DPOnAgRe.js";const l={class:"bg-white rounded-xl shadow-sm border p-6"},c={class:"grid grid-cols-2 gap-6"},b=a({__name:"CommunicationPublication",props:{form:{},yesno:{}},setup(i){const e=i,s=[{label:"I agree",value:!0}];return(u,n)=>(d(),m("div",l,[n[0]||(n[0]=r("h2",{class:"text-lg font-semibold mb-6"},"Step 7:Communication and Publication",-1)),r("div",c,[t(o,{form:e.form,label:`Would you want the STH Research and Development unit to organize a scientific forum
